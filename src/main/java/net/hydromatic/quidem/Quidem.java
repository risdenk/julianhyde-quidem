...
public class Quidem {
  ...
  private boolean getBoolean(List<String> names) {
    ...
    for (int i = 0; i < names.size(); i++) {
      ...
      } else if (value instanceof com.google.common.base.Function) {
        // For backwards compatibility, allow Guava functions
        @SuppressWarnings({"rawtypes", "unchecked"})
        final com.google.common.base.Function<String, Object> f =
            (com.google.common.base.Function) value;
        e = f::apply;
  ...
  public static class ConfigBuilder {
    ...
    /** Guava version of {@link #withEnv(Function)}. */
    @Deprecated // to be removed before 0.11
    public ConfigBuilder withEnv(
        com.google.common.base.Function<String, Object> env) {
      return withEnv((Function<String, Object>) env::apply);
    }
